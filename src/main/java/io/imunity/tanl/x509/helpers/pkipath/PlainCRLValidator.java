 ...
 */
package io.imunity.tanl.x509.helpers.pkipath;
...
import io.imunity.tanl.x509.helpers.crl.PlainCRLStoreSpi;
 ...
 * {@link AbstractValidator#init(TrustAnchorStore, AbstractCRLStoreSPI, RevocationParameters)}
 * method.
 * </p><p>
...
public abstract class PlainCRLValidator extends AbstractValidator
{
	...
	public synchronized void setCrls(List<String> crls)
	{
		...
		init(null, crlStoreImpl, getRevocationCheckingMode());
	}
